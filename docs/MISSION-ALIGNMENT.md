...
| 12–14 Weather/sports/esports | PAPER weather parser + forecast-feature FV; Sports WS cache subscriber (default-off) + NBA/Soccer models (refuse others); esports stub |
